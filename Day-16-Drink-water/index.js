...
const bigCupFill = () => {
  ...
  document.querySelector(".remained-amount .amount").innerHTML = `${2-(activeBottles.length*250/1000)}L`;
  document.querySelector(".drank-amount .amount").innerHTML = `${(activeBottles.length/8)*100}%`;
